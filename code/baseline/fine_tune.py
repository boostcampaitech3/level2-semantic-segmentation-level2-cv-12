...
def train(train_path, val_path, args):
    ...
    checkpoint = torch.load('/opt/ml/input/level2-semantic-segmentation-level2-cv-12/saved/drgon_OCRNet_Hr48_fold2_aug/epoch0074_mIoU06578.pth', map_location=device)
