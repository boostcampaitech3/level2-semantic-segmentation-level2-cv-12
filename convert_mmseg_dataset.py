...
for i in range(10):
    ...
    TRAINJSON = '/opt/ml/input/data/train_'+'fold'+str(i)+'.json'
    VALJSON = '/opt/ml/input/data/val_'+'fold'+str(i)+'.json'
    TESTJSON = '/opt/ml/input/data/test.json'
    '''
    ./data/mmseg
    ./data/mmseg/images/fold_n/training
    ./data/mmseg/images/fold_n/validation
    ./data/mmseg/annotations/fold_n/training
    ./data/mmseg/annotations/fold_n/validation
    ./data/mmseg/test
    '''
    dir_lists = [
        os.path.join(ROOT, 'mmseg', 'images','fold'+str(i), 'training'),
        os.path.join(ROOT, 'mmseg', 'images','fold'+str(i), 'validation'),
        os.path.join(ROOT, 'mmseg', 'annotations','fold'+str(i), 'training'),
        os.path.join(ROOT, 'mmseg', 'annotations','fold'+str(i), 'validation'),
